...
# Read volume
from napari.visuals.napari_volume import NapariVolumeVisual
...
vol1 = np.empty((h, w, d), dtype=np.float32)
vol1[:] = np.exp(- X ** 2 - Y ** 2 - Z ** 2)
...
volume1 = NapariVolume(vol1, parent=view.scene, threshold=0.225,
                               emulate_texture=emulate_texture)
volume1.transform = scene.STTransform(translate=(64, 64, 0))
volume2 = NapariVolume(vol2, parent=view.scene, threshold=0.2,
                               emulate_texture=emulate_texture)
